...
REGISTER=(
  ...
  "crates/topo/src/census.rs|torus_chart_window|LoopBoundary::Empty { .. } => return|1|audited: boolean::boxes::face_box's arm on the same question — this is that walk at the census scalar, and both answer no window, which keeps torus_extent"
