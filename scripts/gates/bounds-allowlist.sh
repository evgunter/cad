...
gate_plant_clean() {
  ...
  # The anchored skip's home is one more of this gate's own subjects: a
  # home that is not in the tree is a red, so the clean tree carries it
  # and the skip is live in every fixture below.
