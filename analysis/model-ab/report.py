...
:root{
  color-scheme: light;
  --page:#f7f8fa; --surface-1:#fdfdfe;
  --text-primary:#0d1117; --text-secondary:#4b5563; --muted:#7c8695;
  --grid:#e3e7ee; --axis:#c2c9d4; --border:rgba(13,17,23,0.11);
  --series-1:#2a78d6; --series-2:#eb6834;
  --good:#0ca30c; --warn:#fab219; --crit:#d03b3b;
  --card:#ffffff;
  --display:"Iowan Old Style","Source Serif 4",Charter,Georgia,serif;
...
@media (prefers-color-scheme: dark){
  :root:not([data-theme="light"]){
    color-scheme: dark;
    --page:#0b0d10; --surface-1:#15181d;
    --text-primary:#f2f5f9; --text-secondary:#b6bfcc; --muted:#828d9c;
    --grid:#252a32; --axis:#333a45; --border:rgba(255,255,255,0.11);
...
h1{font-family:var(--display);font-size:37px;line-height:1.14;
   margin:0 0 8px;letter-spacing:-0.015em;font-weight:600;
   text-wrap:balance}
h2{font-family:var(--display);font-size:25px;margin:56px 0 8px;
   letter-spacing:-0.01em;font-weight:600;padding-top:24px;
   border-top:1px solid var(--border);text-wrap:balance}
h3{font-family:var(--display);font-size:19.5px;margin:34px 0 4px;
   font-weight:600;text-wrap:balance}
h4{font-family:var(--body);font-size:14px;margin:26px 0 4px;
...
.chart .ct{fill:var(--text-primary);font-size:14.5px;font-weight:600;
...
.tile .k{font-family:var(--display);font-size:28px;font-weight:600;
...
.callout .h{font-family:var(--display);font-weight:600;font-size:15.5px;
  margin-bottom:3px}
