...
**The worst: two `[Expr; 3]` relayed positionally over two hops.**
    ...
    crates/viewer/src/session.rs:1735   fn add_transform(… same four …)
    crates/viewer/src/session.rs:1746   combine::transform_node(input, translation,
