...
**The worst: two `[Expr; 3]` relayed positionally over two hops.**
    ...
    crates/viewer/src/session.rs:1696   fn add_transform(… same four …)
    crates/viewer/src/session.rs:1707   combine::transform_node(input, translation,
