...
- `crates/viewer/src/app.rs:962-965`, the `None if opened` arm of
...
(`crates/viewer/src/session.rs:1653-1656`) is two statements,
...
`app.rs:956-961`, carries the argument and the declarations do not).
