---
id: renamed-module-leaves-citations-in-three-other-programs
kind: issue
title: the pick to pickcache rename leaves four open rows on three other programs' slates citing crates/viewer/src/pick.rs
status: open
opened: 2026-09-06
---
...
- `work/chrome/edge-cost-claims-name-a-search-that-is-gone.md:13,19` —
  ...
  first commit moved again to `crates/viewer/src/marks.rs:247`. The
