...
as the design page for this directory, present tense, and the
conclusion is: **the greps stay, with their gaps registered.** No gate
is replaced by a lint, so there is no design change here and nothing
for Ev to rule on.
