...
track: the kiss/cusp lane (`m9-3-semantic-residues` items 4–5, the
DEV-1 cylinder×sphere circle-locus arm, the declared-cusps second-order
wedge arm, the torus 0/2π kissing arm), the cyl×cyl germ and pierce
remainder (arc-aware point-in-loop, the pierce ring's join arm, the
arc-carrier refusal), and the valence-4 pinch machinery. Small and
Ev-gated: each unit's spec opens with the design question it settles.
Opened 2026-09-20 with eight items; nothing dispatched. Charter and
order: `work/tang/plan.md`; narrative in `work/tang/log.md`.
