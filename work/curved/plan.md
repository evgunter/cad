...
Branch prefix (the #396 convention): **`curved/`** — unit branches
`curved/<unit>-<slug>`, orchestrator branch `curved/orchestrator`.
Away-channel tag `(CURVED orchestrator)`. A/B ordinal band
...
Full v6 dual with Fable specs; the two E drive-bys take a single
review.
