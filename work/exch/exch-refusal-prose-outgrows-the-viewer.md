---
id: exch-refusal-prose-outgrows-the-viewer
kind: issue
title: step-import/export: the exchange refusals over 50 words (Ev's concision request)
status: open
opened: 2026-09-22
...
| words | site | arm |
|---|---|---|
| 67 | `step-import/src/error.rs` `StepImportError::TierInvalid` | |
| 62 | `StepImportError::RimOffWallBoundary` | |
| 54 | `StepImportError::RecognitionAmbiguous` | |
| 54 | `step-export/src/lib.rs` `StepExportError::UnsupportedSurface` | (also EXPORT's ground) |

These reach the viewer through the document import/export doors
(`crates/viewer/src/docio.rs`).
