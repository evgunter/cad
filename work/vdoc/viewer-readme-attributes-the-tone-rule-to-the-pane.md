...
otherwise have kept it in hand. **The collision between those two rules
is itself worth VDOC knowing about**: this row exists because the
file-specific carve-out won.
