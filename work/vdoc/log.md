...
Plan: `work/vdoc/plan.md`. A/B band 5500–5599
...
22 rows arrived from `work/view/`, each by `git mv` with its body,
...
- `session-shims-and-test-imports`
- `stale-file-citations-after-the-split`
...
- `tree-rs-header-growth-moved-five-cited-subjects`
- `viewer-lib-marker-claims-the-log-carries-its-sentence`
- `viewer-prose-calls-the-frame-entry-point-update`
...
§Charter. The band 5500–5599 is claimed in `docs/MODEL-AB-LOG.md` in the
