...
- **Where**: `crates/topo/src/euler.rs:1940` (and 57 siblings),
  ...
  `docs/DESIGN.md` D9's no-panic bullet (`Cargo.toml`'s `indexing_slicing` deferral was
...
to D9** (`docs/DESIGN.md` D9's D2 addendum, PR #628; Wave 0 decision D2). Five idioms
...
DESIGN.md's D9 graft paragraph, the 37-door allowlist entry at
...
Its class at the cut was **M** — rule ratified as D2 addendum; leftover
is one crate's conversion with per-site proofs. The class is a dispatch
