...
ab_band: 1500-1599
paths: [.github/workflows/*, local-scripts/*, .claude/hooks/*, scripts/apt-install.sh, demos/*.sh, demos/*.py, scripts/check-*.py, scripts/criterion-emit.py, scripts/opt-level-calibrate.py, scripts/nightly-only-selection.py, scripts/pr-added-tests.py, scripts/doc-gate.sh, scripts/rundump-guard-selftest.sh, scripts/check_admesh.sh, scripts/check_step.sh, scripts/k_probe_sweep.sh, scripts/tess_budget_cut.sh, scripts/tess_budget_sweep.sh]
