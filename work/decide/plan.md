...
value-free residual. `rule-d-reaches-the-unit-bulge-only` stays open on
the bulge's sign, which is Ev's fork on `[ev]` #3186. Its route B, if
ruled, is its own unit.
