...
| P1 | `registered-is-spelled-five-times-and-pinned-once` | E | the discharge vocabulary is spelled five times across two crates and only one pair is pinned |
...
`declared-tangency-needs-the-registered-identity-door`, which is what
the PATHS fillet family is waiting on.
`registered-is-spelled-five-times-and-pinned-once` is a drive-by.
