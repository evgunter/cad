...
DESIGN.md's Layering table (the `topo` row) with its *"the boolean engine and its splitting/census
...
Its class at the cut was **H** — unifies two engines: ~267 tests over 36
files, error-type API, design conversation. The class is a dispatch
