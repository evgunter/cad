...
Cut out of TINT, which was carrying 97.5 budget points, when Ev
ratified the priority and track-size conventions in chat the same day.
The cut followed TINT's PRIORITY seam per `work/README.md` "Track
...
20 rows arrived by `git mv` with their ids, bodies and history
