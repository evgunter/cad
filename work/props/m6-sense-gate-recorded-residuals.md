...
4. **Arc-bounded planar caps check-6-exempt** (the pre-existing deferral; whole-body cases now caught via circle-rimmed curved walls — but a body with ONLY arc-bounded planar faces + conic-trimmed walls remains uncovered, per residual 1's counterexample). Flip condition: check 6's arc-bounded planar arm.
