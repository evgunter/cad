...
class T:
    ...
    def arc(s,ring,turn):
        ...
        adv = rot(radial,turn)
        return dict(center=c,radial=radial,ring=ring,turn=turn), T((c[0]+ring*adv[0], c[1]+ring*adv[1]), rot(s.t,turn))
...
ARCH_R=0.052
FLOWER_GLOBE=0.44; FLOWER_TOP=0.40
alpha=70.0*PI/180.0
...
print("old SPHERE1_C     ",repr(oldC), " PR-before (-2.3934135869350324, 0.919255622187704)")
d=math.dist(C1,oldC); print("globe moved by",repr(d))
# torus carrier for the arch
print()
print("=== torus/meridian check (exact f64 arithmetic in python = f64) ===")
Cx,Cz=upper['center']
w0=P2[0]-Cx; w2=P2[1]-Cz
