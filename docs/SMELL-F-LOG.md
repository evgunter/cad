...
**Wave 1.** These lanes share no file with each other, with Track C's open
lanes, or with Track E's. **F-a and F-b are done** — F-a's PR (#788) is open
with its F-R8/F-R9 fix pass in it; see *Landings* for both.
