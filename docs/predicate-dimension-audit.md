...
| census.rs (M9-2 PR-2 fix pass) | census_backstop_gap | per-axis inter-hull gap minus both faces' reach pads (coordinate differences and radii — metres); only a DEFINITE positive clears the pair | m | OK (new in the union fix) |
