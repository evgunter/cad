...
| `docs/predicate-dimension-audit.md` | LIVE working audit | Dimensional-analysis sweep; open findings F2 and F8–F15 (F1, F3–F7 retired — F6's residue closed with F7) |
