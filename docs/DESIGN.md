...
| `geom` | Analytic + NURBS types, evaluators, closest-point, curve×curve and curve×surface intersection. Curves and surfaces are two modules of one crate: identical manifests, one set of §6.1 projection constants, and the shared parameterization conventions stated once in the crate docs |
