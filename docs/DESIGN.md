...
- **M5** — NURBS depth (sweeps/lofts); first SSI marching; constant-radius
  ...
  **#89 K-revisit at the M5 exit**, now with its baseline: 8b's
  ...
  in-house `interval-transcendentals` crate exists as
