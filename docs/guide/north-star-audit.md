...
**Result: 39 of the 45 tour stops are authorable through Python
today** — 36 outright, and 3 more only with a caveat the row states:
...
shell).
G8 blocks none and still degrades three, which is what makes three
rows YES\* rather than YES (40, 41, 42) — they carry G8 in the gap
...
the half the mark depended on. Its count fell from four at
...
reading.
Authorable = 36 outright + 3 YES\* = 39, and 39 + 6 = 45.
