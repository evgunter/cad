...
G2 and G5 partition the 8 NO rows: 6 + 2 = 8, counted off the table
above (G2: rows 10, 15–19; G5: 21, 28). G14 partitioned the ninth
(row 31) until LIB-G14 closed it. G8 degrades three, which is what
makes three rows YES\* rather than YES (32, 33, 34). Authorable =
23 outright + 3 YES\* = 26, and 26 + 8 = 34.
