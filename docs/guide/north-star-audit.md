...
**Result: 36 of the 43 tour stops are authorable through Python
...
it through a different node than the scene's. 7 are blocked by a
missing door.
...
The three gaps partition the 7 NO rows exactly, counted off the table
above: **G2** takes 5 (rows 13, 19–22), **G17** 1 (row 27) and
**G19** 1 (row 38) — 5 + 1 + 1 = 7. **G16** takes 0: LIB-G16 closed
...
Authorable = 32 outright + 4 YES\* = 36, and 36 + 7 = 43.
