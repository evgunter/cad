...
G2 and G14 partition the 7 NO rows: 6 + 1 = 7, counted off the
table above (G2: rows 10, 15–19; G14: 31). G8 degrades three, which
is what makes three rows YES\* rather than YES (32, 33, 34).
Authorable = 24 outright + 3 YES\* = 27, and 27 + 7 = 34.
