...
One further gap is no row's PRIMARY blocker but matters to the
library. (There were two until LIB-G11 built the mesh door; the
closed-gaps table below is where G11 went, and its anchor — the
generic ladder, not a stop — is why closing it moved no mark.)
