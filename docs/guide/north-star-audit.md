...
**Result: 34 of the 47 tour stops are authorable through Python
today** — 30 outright, and 4 more only with a caveat the row states:
three re-author by hand what the scene says structurally, and one says
it through a different node than the scene's. 13 are blocked by a
missing door.
...
The four gaps partition the 13 NO rows exactly, counted off the table
above: **G2** takes 8 (rows 13, 20–24, 26, 27), **G16** 3 (rows 2, 11,
12), **G17** 1 (row 28) and **G19** 1 (row 39) — 8 + 3 + 1 + 1 = 13.
...
Authorable = 30 outright + 4 YES\* = 34, and 34 + 13 = 47.
