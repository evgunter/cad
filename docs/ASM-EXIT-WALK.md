...
**STATUS: PROPOSED — awaiting Evan's sign-off; the ASM program
closes on his 👍 on this document's PR.** ASM = the assemblies
...
- **Side lanes discharged en route** (Evan-assigned, not
...
- **Open with named owners at walk time**: #943 (census
  ...
  face door), #945 (mates × patterns + A11 rule 4 — **needs
  Evan**), #946 (sub-assembly declarations at the seam), #947
