...
**STATUS: RATIFIED — S-QA CLOSED (Ev's approval given directly
...
- **What the program found beyond its slate**: main latently red
  ...
  code-tier look (Ev fixed it directly, #1323); the
