...
- **The globe lily**: the 15-row disposition table (scorecard in the
  #223 thread; the runway ruling is
  https://github.com/evgunter/cad/pull/223#issuecomment-5211450936 —
  "close M6 at its ratified boundary", Evan 👍) is the walk's
  worked-example evidence; the lily REBUILD rides M8 per that ruling,
  not M6. [VERIFY at presentation: the scorecard comment's own
  permalink.]
