...
**No row number is reserved; D67 is the highest one placed.** Placements:
...
PR's own review; **D54** and **D67** came out of **#767** (D28) — that unit
closed every arm whose payload had a `Display`, leaving D54's six whose payload
is an editor-core type that has none, and its review found D67: the same class
