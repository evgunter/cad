...
census) and **D25** by the same PR's style review (a `Live` half-edge key
type, which would retire that precondition rather than restate it). Every one
of them was placed by a lane on its way out rather than left
