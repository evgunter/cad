...
- (a) `crates/topo/tests/probe_s5_sectors.rs:164-172` — six per-lane
  ...
  it is not a homeless member of this roll-up, it is that row's
  probe-suite finding stated from the other end. Cited by row, not by
  D-number: E-b's re-derivation renumbered F8's two halves while this
  was in review.
