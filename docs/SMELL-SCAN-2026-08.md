...
PRs.** D5, D6 and D8 are edge-free — D5 and D6 in flight, D8 unstarted
(D3 landed as #704, D4 as #707). D8 edits `sweep/src/skin.rs`, so it sequences
against D1/D2 within the track rather than across it.
