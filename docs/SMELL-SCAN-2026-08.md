...
larger than it: raised as Track D row **D12**, diagnosis-first.
...
the rows marked ADVERSARIAL — D2, D8, D9, D12, and D1 before it landed — and
D5's `seqgen` half.
