...
Of the two remaining rows, **`PairSolve` is unblocked** — #702 merged
2026-08-20 as `f382c4aa` — and the fillet helpers still wait on **D2** and on
**#705**.
...
| Was | Now |
|---|---|
| **U1** — S11/D4's three decided deletions | **D7**, split by row: `Mat2`/`Affine2` done (#721), `PairSolve` free since #702 merged, the fillet helpers behind D2 and #705 |
...
PR.** D8, D11, D13, D14, D15 and D16 are edge-free and unstarted (D1
landed as #710, D3 as #704, D4 as #707 — which also discharges D13's gate —
D5 as #713, D6 as #706, D9 as #712, D10 and D12 as #717). D8 edits `sweep/src/skin.rs`, so it
