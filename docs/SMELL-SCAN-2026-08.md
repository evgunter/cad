...
**No row number is reserved; D46 is the highest one placed.** Placements:
...
prose-held at 102 sites the week the mechanism was ratified — and **D46** by
**#761** (D33), the 23 funnel-reaching names in the audit's own two crates that
its 143 rows reach under no reading. Every one of them
