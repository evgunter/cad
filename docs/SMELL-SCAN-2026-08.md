...
**No row number is reserved; D31 is the highest one placed.** Placements:
...
**#740**, and **D30** and **D31** by **#744** — a second span search for knot
lists the validated type cannot represent, and a union-and-refine routine
duplicated across two crates on top of the query that unit gave a home. Every
...
and **D25**, D2's as **D26–D29** and D8's as **D30** and **D31** — including **D26**, which is not D2's own
...
whose two C¹ carrier gates are now four lines each — and **placed D30** and
**D31**.
**Nothing is in flight.**
**D17, D19, D20, D21, D25, D26, D28, D30 and D31 are edge-free and unstarted** — though
