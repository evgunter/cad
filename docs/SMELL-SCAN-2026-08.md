...
**Track E holds `D81`-`D100`**, taken as a block for the reason Track F's and Track G's blocks record below: one allocator per branch is not a sequence, and four orchestrators reading `main` computed the same next free number. **D81 is the highest one placed.** Placements:
