...
**D20** by **#722**, and **D26–D29** by **#740** (D5's +46%, unattributed once that unit's measurement
...
D1 (#710) ──► D2 (#740, landed) ──────────────────► D7's fillet-helper row
...
measurement left unattributed — and **D2 as #740**. **Nothing is in flight.**
