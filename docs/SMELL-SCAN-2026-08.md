...
`K-REPORT.md:209` is stated over *types* holding row names where the
...
- **The convention charged, and this diff paid it.** The four-field
  ...
  row-name table explicitly (`K-REPORT.md:209`); the `ROWS` blocks say so
...
the rows marked ADVERSARIAL — D2 and D8 still live, with D1
(**retired, #710**), D9 (**retired, #712**), D15 (**retired, #718**)
and D11 (**retired, #719**)
