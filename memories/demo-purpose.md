---
name: demo-purpose
description: The demos' binding purpose (Evan, 2026-08-09) — demonstrate REAL natural library usage; awkwardness is a library finding, never hidden
metadata:
  type: feedback
---

**The demos exist to demonstrate real, natural library usage** — the
way a user would actually write the model (Evan, 2026-08-09). They are
