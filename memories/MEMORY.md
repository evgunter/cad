...
- [CAD project state](cad-project-state.md) — DESIGN.md is the ratified contract; M0/M1/M2 COMPLETE; M3 near exit (PRs 1–5.5 + 6a #75 + 6c #73 merged; NAMING-DESIGN ratified #74; 6b docs sweep + exit walk remain); merge gate = scripts/gate.sh (hosted CI DOWN, --auto merges immediately); references live in the MAIN checkout; name pending
