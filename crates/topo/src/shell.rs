...
/// certifying scalar.
pub fn shell<T: Decide + PropsQuadLane + geom_core::CertifiedBounds + crate::props::AtRestPolicy>(
    body: &Body<T>,
    thickness: T,
    tol: Tol,
...
pub fn shell_open<T: Decide + PropsQuadLane + geom_core::CertifiedBounds + crate::props::AtRestPolicy>(
    body: &Body<T>,
    thickness: T,
    open_faces: &[FaceKey],
    tol: Tol,
