...
/// and behind it the cylinder chart trim). An endpoint that door does
/// not decide keeps the typed frontier refusal, and UNDECLARED
/// incidences keep both frontier doors untouched — the door only
/// widens what a verified declaration unlocks.
///
        ...
        geom::Curve3::Circle {
            ...
            return match decide("bool_circle_curved_clearance", margin, band) {
                ...
                Ok(Sign::Zero) if covered => {
                    ...
                    // An endpoint the containment door cannot decide
                    // keeps the frontier door.
