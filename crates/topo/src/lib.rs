...
pub use geom_brep::{
    CertifyError, ChartCurve, ChartWindow, EdgeAuthority, EdgeCurve, EdgeCurveSpec, EdgeDescription,
    EdgeDescriptionSpec, EdgeNurbsLane, Pcurve, PcurveCache, PcurveCertifyError,
};
