...
pub use boolean::{
    ...
    NullEdgePairRecord, Operand, PairSite, PierceRingRecord, PlaneDesc, PlaneEqError, PlaneRelation,
    SideCode, VfContact, VvContact, boolean_reduce, contfp, oriented_plane_eq,
};
pub use entity::{
