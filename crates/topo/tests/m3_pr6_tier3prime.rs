...
fn assert_promoted<T: Decide + geom_core::CertifiedBounds + topo::AtRestPolicy>(
    b: &BooleanBody<T>,
) {
    assert_eq!(
...
fn tier3_equivalence_scenario<T: Decide + geom_core::CertifiedBounds + topo::AtRestPolicy>() {
