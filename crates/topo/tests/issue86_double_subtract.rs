...
fn double_subtract_crossing_slots<T: Decide + geom_core::Bounds + geom_brep::PcurveFittedLane + topo::AtRestPolicy>()
-> BooleanBody<T> {
...
fn assert_result_sound<T: Decide + topo::PropsQuadLane + geom_core::Bounds + topo::AtRestPolicy>(out: &BooleanBody<T>) {
