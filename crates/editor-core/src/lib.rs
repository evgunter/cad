...
pub use resolve::{
    ...
    ResolveIndeterminate, Resolved, RunCtx, RunStatus, SHADOW_EXEC_MAX_PAIRS, TieWitness,
    Tombstone, VerdictFlip, appearance_rebind_suggestions, apply_with_names, body_name,
