...
fn schema_version_is_current() {
    // Moved three times since this row was written (LIB-RESPELL's v9
    // §2c re-spell, ASM-UPD's v10 `UpdateReference` arm, then
    // LIB-PLACEDUNION's v11 group boolean) — the
