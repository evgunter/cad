...
//! patch. Its carve is [`ruled_phase`]'s: at each cap the two rim
...
// ------------------------------------------------------------------
// The ruled band: the open band on curved supports, cut off at
// transverse caps.
// ------------------------------------------------------------------
//
