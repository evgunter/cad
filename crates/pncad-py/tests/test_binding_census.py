...
1. `pncad.pyi` declares a top-level name spelled identically —
   ...
   bullet used to carry had already decayed twice in place (it read
   "sixty-two" at 111 and "a hundred and twenty-four" after), which is
   the argument. What stops a scanner passing vacuously is the FLOORS
