...
class PathPoint:
    ...
    @overload
    def arc_to(self, spec: _PointLeg, splits: int = 1) -> PathDirectedPoint: ...
    @overload
    def arc_to(self, spec: _PointClose, splits: int = 1) -> ClosedLoop: ...
...
class PathDirected:
    ...
    def arc_to(self, spec: _Tangent, splits: int = 1) -> PathDirectedPoint: ...
