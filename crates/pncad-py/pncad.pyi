...
class PathPoint:
    ...
    @overload
    def arc_to(self, spec: _PointLeg, splits: int | None = None) -> PathDirectedPoint: ...
    @overload
    def arc_to(self, spec: _PointClose, splits: int | None = None) -> ClosedLoop: ...
...
class PathDirected:
    ...
    def arc_to(self, spec: _Tangent, splits: int | None = None) -> PathDirectedPoint: ...
