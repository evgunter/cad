...
//! count is deliberately NOT restated in prose: `every_suite_file_is_
//! aggregated` below checks this file against the directory on every
//! run, and a number written out beside it is a second, unchecked copy
//! of a set the compiler already knows.
//!
