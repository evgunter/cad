//! Aggregated integration-test binary for `geom-surfaces`.
//!
//! Every `tests/*.rs` suite is included here VERBATIM via `#[path]`, so
//! this one binary replaces what were 9 separate test targets. The files
...
mod m5_pr7_surface_projection;
#[path = "nurbs_surface.rs"]
mod nurbs_surface;
#[path = "nurbs_surface_interval.rs"]
mod nurbs_surface_interval;
#[path = "review_m2_pr1.rs"]
mod review_m2_pr1;
#[path = "review_m2_pr1_interval.rs"]
mod review_m2_pr1_interval;
