...
//! NOT the outward normal in general (the outward normal is the chart
//! normal with `topo::Face::sense` folded in), but the walk never
//! depended on it and needs no repair. The sense must NOT be folded
//! in here: `revert`
