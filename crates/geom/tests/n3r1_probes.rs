...
//! ordinary row: an independent adversarial conic-box corpus (f64, `Interval`, `Dual64`) and the exactly-π extremal-angle rows that pin the door's branch-cut handling in its own crate. The timing row stays `#[ignore]`d — a meter, not a gate.
//!
